...
print("Recall score: %2f" % metrics.recall_score(y_train, y_predicted_train))
print("Precision score: %2f" % metrics.precision_score(y_train, y_predicted_train))
print("Accuracy score: %2f" % metrics.accuracy_score(y_train, y_predicted_train))
print("F1 score: %2f" % metrics.f1_score(y_train, y_predicted_train))
...
dot_data = tree.export_graphviz(model, feature_names=breastCancer.feature_names[:numberOfFeatures],
                                class_names=breastCancer.target_names, filled=True, rounded=True, out_file=None)
